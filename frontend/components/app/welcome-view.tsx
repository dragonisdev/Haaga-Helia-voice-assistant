...
function WelcomeImage() {
  return (
    <svg
      ...
      className="text-fg0 mb-6 size-16 md:size-20"
    >
      <path
...
export const WelcomeView = ({
  ...
  return (
    <div ref={ref} className="h-full flex flex-col items-center justify-center p-4">
      <section className="bg-background flex flex-col items-center justify-center px-4 md:px-8 text-center max-w-2xl mx-auto rounded-3xl py-8 md:py-12">
        <WelcomeImage />

        <h1 className="text-foreground text-2xl md:text-3xl font-semibold tracking-tight my-2 md:my-4">
