...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      'group-[.is-user]:border-primary/20 group-[.is-user]:bg-primary/12 group-[.is-user]:text-foreground group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:border group-[.is-user]:px-4 group-[.is-user]:py-3',
