...
```json
{
  "mcpServers": {
    "exa": {
      "url": "https://mcp.exa.ai/mcp?exaApiKey=68493e93-ad27-41f0-8951-13b2d91c3a7a"
    }
  }
}
```
...
```
https://mcp.exa.ai/mcp?exaApiKey=68493e93-ad27-41f0-8951-13b2d91c3a7a&tools=web_search_exa,get_code_context_exa,people_search_exa
```

Enable all tools:
```
https://mcp.exa.ai/mcp?exaApiKey=68493e93-ad27-41f0-8951-13b2d91c3a7a&tools=web_search_exa,web_search_advanced_exa,get_code_context_exa,crawling_exa,company_research_exa,people_search_exa,deep_researcher_start,deep_researcher_check
```

**Your API key:** `68493e93-ad27-41f0-8951-13b2d91c3a7a`
...
def exa_search(query: str) -> str:
    results = exa.search_and_contents(query, type="auto", num_results=10, highlights={"max_characters": 4000})
...
```javascript
await exa.searchAndContents("AI safety discussion", {
  "category": "tweet",
  "type": "auto",
  "numResults": 10,
  "text": {
